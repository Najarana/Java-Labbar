...
public class BlogManager {
	...
	public void updatePost(int index, String newTitle, String newContent, String tag) {
		calobj = Calendar.getInstance();
		Date dater = calobj.getTime();
	...
	//Searches all posts for elements containing search
	public void searchAll (){
		System.out.print("Enter a search, part of title, tag or date using dd/MM/yy HH:mm:ss format");
	...
	//Divided search methods. Not sure if my catch all "searchAll" method is good enough
